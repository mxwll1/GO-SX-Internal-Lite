...
//  GOSX Pro
//
//  Created by Andre Kalisch on 15.03.17.
...
public:
    ...
    virtual void ShowMessageDialog( const uint nType, IPanel *pOwner ) = 0;
    ...
    virtual void SetLoadingBackgroundDialog( VPANEL panel ) = 0;
    ...
    virtual void SetMainMenuOverride( VPANEL panel ) = 0;
